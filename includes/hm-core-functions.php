...
function hm_help_hub_contents() {
	...
	get_template_part('admin/tutorial-videos'); 
...
function hm_launch_portal_contents() {
	...
	get_template_part('admin/launch-portal'); 
...
function my_login_logo_one() { 
	...
	function my_custom_dashboard_widgets() {
		...
		wp_add_dashboard_widget('custom_help_widget', 'Hewitt Matthews Help Hub', 'hm_dashboard_help');
		wp_add_dashboard_widget('hm_ads_widget', 'Hewitt Matthews Digital Marketing Services', 'hm_ads_widget');
		if ( current_user_can( 'client' ) ) {
